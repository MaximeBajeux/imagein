      ...
      <Row>
        <Col xs={12}>
          ...
          <div className="nv-content-wrap entry-content">
            <h2 className="wp-block-heading">Informations légales</h2>
            <h3 className="wp-block-heading">1. Présentation du site.</h3>
            <p>
            ...
            <div>
              ...
              <br />
              <strong>Hébergeur</strong> : OVH SAS – 2 rue Kellermann 59053
              Roubaix
              <br />
            ...
            <p>
              ...
              toutefois décidée par Maxime Bajeux, qui s’efforcera alors de
            ...
            <p>
              ...
              <a href="//image-in.net/">image-in.net</a> ne sont pas exhaustifs.
            ...
            <p>
              Maxime Bajeux est propriétaire des droits de propriété
            ...
            <p>
              ...
              écrite préalable de : Maxime Bajeux.
            </p>
            <p>
            ...
            <p>
              Maxime Bajeux ne pourra être tenue responsable des dommages
              directs et indirects causés au matériel de l’utilisateur, lors de
              l’accès au site image-in.net, et résultant soit de l’utilisation
            ...
            <p>
              Maxime Bajeux ne pourra également être tenue responsable des
            ...
            <p>
              ...
              échéant, Maxime Bajeux se réserve également la possibilité de
            ...
            <p>
              ...
              <a href="//image-in.net/">image-in.net</a>, peuvent êtres
              recueillies : l’URL des liens par l’intermédiaire desquels
              l’utilisateur a accédé au site{" "}
              <a href="//image-in.net/">image-in.net</a>, le fournisseur d’accès
            ...
            <p>
              ...
              <a href="//image-in.net/">image-in.net</a>. L’utilisateur fournit
              ...
              à l’utilisateur du site <a href="//image-in.net/">image-in.net</a>{" "}
            ...
            <p>
              Le site <a href="//image-in.net/">image-in.net</a> contient un
              certain nombre de liens hypertextes vers d’autres sites, mis en
              place avec l’autorisation de Maxime Bajeux. Cependant, Maxime
              Bajeux n’a pas la possibilité de vérifier le contenu des sites
              ainsi visités, et n’assumera en conséquence aucune responsabilité
              de ce fait.
            </p>
            <p>
              La navigation sur le site{" "}
              <a href="//image-in.net/">image-in.net</a> est susceptible de
            ...
            <p>
              ...
              sur préférences. Dans l’onglet «&nbsp;Confidentialité&nbsp;», vous
            ...
            <h3 className="wp-block-heading">11. Lexique.</h3>
            <p>
