  ...
  return (
    <Layout>
      ...
      <p>
        ...
        lesquelles Image IN traite les données à caractère personnel collectées
        sur son site web.
      </p>

      <h2>Article 2: Collecte des données à caractère personnel</h2>
      <p>
        2.1. Dans le cadre de la demande de devis, Image IN collecte les données
        suivantes :
      </p>
      <ul>
      ...
      <p>
        ...
        Confidentialité à tout moment, notamment en application des changements
        apportés aux lois et réglementations en vigueur.
      </p>

      <h2>Article 8: Contact</h2>
      <p>
        Pour toute question relative à la présente Politique de Confidentialité,
        veuillez vous adresser à Maxime Bajeux, référent en matière de
        protection des données, à contact@image-in.net.
      </p>
    </Layout>
  );
};
