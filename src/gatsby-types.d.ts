...
type BlogListQuery = { readonly allMdx: { readonly totalCount: number, readonly nodes: ReadonlyArray<{ readonly id: string, readonly frontmatter: { readonly title: string, readonly label: string, readonly slug: string, readonly date: string, readonly description: string, readonly categories: ReadonlyArray<string | null> | null, readonly imageAlt: string | null, readonly image: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly imageRemote: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null }> } };
...
type BlogPostQuery = { readonly mdx: { readonly tableOfContents: Record<string, unknown> | null, readonly frontmatter: { readonly title: string, readonly label: string, readonly h1: string, readonly slug: string, readonly date: string, readonly description: string, readonly imageAlt: string | null, readonly image: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly imageRemote: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null };

type CategoriesQueryVariables = Exact<{ [key: string]: never; }>;


type CategoriesQuery = { readonly allMdx: { readonly nodes: ReadonlyArray<{ readonly frontmatter: { readonly categories: ReadonlyArray<string | null> | null } | null, readonly internal: { readonly contentFilePath: string | null } }> } };
...
type IndexPageQuery = { readonly allFile: { readonly nodes: ReadonlyArray<{ readonly name: string, readonly publicURL: string | null }> } };

type LabQueryVariables = Exact<{
  id: InputMaybe<Scalars['String']>;
}>;


type LabQuery = { readonly mdx: { readonly frontmatter: { readonly title: string, readonly label: string, readonly h1: string, readonly slug: string, readonly date: string, readonly description: string, readonly imageAlt: string | null, readonly image: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly imageRemote: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null };

type LabListQueryVariables = Exact<{ [key: string]: never; }>;


type LabListQuery = { readonly allMdx: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly frontmatter: { readonly title: string, readonly label: string, readonly h1: string, readonly slug: string, readonly date: string, readonly description: string, readonly imageAlt: string | null, readonly image: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly imageRemote: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null }> } };

type LastArticlesQueryVariables = Exact<{ [key: string]: never; }>;


type LastArticlesQuery = { readonly allMdx: { readonly totalCount: number, readonly nodes: ReadonlyArray<{ readonly id: string, readonly frontmatter: { readonly title: string, readonly label: string, readonly slug: string, readonly date: string, readonly description: string, readonly categories: ReadonlyArray<string | null> | null, readonly imageAlt: string | null, readonly image: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly imageRemote: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null }> } };
...
type RealisationQuery = { readonly mdx: { readonly frontmatter: { readonly title: string, readonly h1: string, readonly label: string, readonly date: string, readonly description: string, readonly slug: string, readonly imageAlt: string | null, readonly image: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly imageRemote: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null };

type RealisationListQueryVariables = Exact<{ [key: string]: never; }>;


type RealisationListQuery = { readonly allMdx: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly frontmatter: { readonly title: string, readonly label: string, readonly h1: string, readonly slug: string, readonly date: string, readonly description: string, readonly imageAlt: string | null, readonly image: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly imageRemote: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null }> } };
...
type SiteMetaDataQuery = { readonly site: { readonly siteMetadata: { readonly author: string | null, readonly description: string | null, readonly siteUrl: string | null, readonly title: string | null } | null } | null, readonly featuredImage: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null };

type AllPostsQueryVariables = Exact<{ [key: string]: never; }>;


type AllPostsQuery = { readonly allMdx: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly frontmatter: { readonly slug: string, readonly categories: ReadonlyArray<string | null> | null } | null, readonly internal: { readonly contentFilePath: string | null } }> } };
