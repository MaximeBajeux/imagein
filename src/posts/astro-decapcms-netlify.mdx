...
Si Tailwind a été une révolution en son temps, permettant d’aller encore un peu plus loin dans la philosophie full components et à des devs fullstack et back de faire du CSS sans en faire réellement, on regrette énormément sa maintenabilité dans le temps.
...
Pour l'instant, on est plutôt satisfait de cette stack. On a pu faire un site en quelques jours, avec un CMS, un rendu statique, un déploiement automatique et un style qui tient la route.

Le site est loin d'être terminé, d'ailleurs question contenu, pour l'instant c'est du 100% ChatGPT dans son jus 😅

[Découvrir le site santedefemmes.fr](https://santedefemmes.fr/)

Mais on aime la promesse faite par cette stack, et on a hâte de voir ce que ça donne sur un projet plus conséquent !