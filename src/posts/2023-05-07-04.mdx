...
<Row>
  <Col xs={12} md={4}>
    ![Un screeshot d'un site web mal optimisé pour le
    mobile](https://sp-ao.shortpixel.ai/client/to_auto,q_glossy,ret_img,w_387/https://image-in.net/wp-content/uploads/2023/04/Capture-decran-2023-04-11-184803.png)
  </Col>
  <Col xs={12} md={4}>
    ![Un screeshot d'un site web mal optimisé pour le
    mobile](https://sp-ao.shortpixel.ai/client/to_auto,q_glossy,ret_img,w_388/https://image-in.net/wp-content/uploads/2023/04/Capture-decran-2023-04-11-185205.png)
  </Col>
  <Col xs={12} md={4}>
    ![Un screeshot d'un site web mal optimisé pour le
    mobile](https://sp-ao.shortpixel.ai/client/to_auto,q_glossy,ret_img,w_403/https://image-in.net/wp-content/uploads/2023/04/Capture-decran-2023-04-13-110337.png)
  </Col>
</Row>
