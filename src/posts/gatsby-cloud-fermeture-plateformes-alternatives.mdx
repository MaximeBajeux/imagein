...
Cependant, avec l'émergence d'**Astro**, et notamment sa version 3.0, la donne pourrait changer. Ce nouveau framework, créé par Fred K. Schott, promet encore plus de performance que GatsbyJS, notamment en mode sans JS. Astro se veut plus simple, plus moderne, plus rapide et ne se repose pas exclusivement sur React: est-ce l'avenir de la **Jamstack** ?
...
C’est peut-être là que ça pèche. Gatsby Cloud était le candidat parfait pour déployer un site GatsbyJS et à cet exercice il y réussissait plutôt bien. Build plus rapide, prévisualisations en temps réel et une intégration sans faille avec le framework GatsbyJS étaient parmi ses points forts. Cependant, là où Gatsby Cloud a peut-être manqué le coche, c'est dans sa capacité à se différencier suffisamment des autres plateformes cloud concurrentes.

### Image IN et Gatsby Cloud : Une collaboration réussie

Chez Image IN, nous aimions bien **Gatsby Cloud**, à vrai dire, jusqu’au 26 septembre 2023, le site y était hébergé. Ce que nous aimions particulièrement étaient les avantages du plan gratuit. 1000 minutes de build, 100Go de bande passante, 3 sites, c’était tout à fait suffisant et plus que la plupart des autres plateformes cloud.
...
La proposition était simple, externaliser l’écosystème de plugins sources de Gatsby afin que n’importe quel framework puisse s'y brancher via une **API GraphQL** unifiée. Le rachat ayant eu lieu à peine plus tard, le projet n’a pas vraiment eu le temps de faire ses preuves.
